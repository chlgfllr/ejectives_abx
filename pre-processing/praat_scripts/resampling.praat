...
form Change sample rate in sound files
   ...
   text input_directory  /Users/chloe/features_extraction/test/wavs/
   comment Directory path of resampled files (old files will be overwritten!):
   text output_directory  /Users/chloe/features_extraction/test/wavs/
