...
TEST=egg_fixed
FOLDER=deltas_log2_absolute__by__place_position_question_speaker_vowel
DIR=../results/$TEST
...
mkdir -p $DIR/$FOLDER && \
  prepare_abx $DIR/egg_deltas_log2_absolute.csv $DIR/$FOLDER/$NAME --header \
     --col_features 14-37 --col_labels 5-12 --col_items 1-3 && \
