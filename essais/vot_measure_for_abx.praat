...
form Extract VOT measures from TextGrid
	...
	text resultsfile /Users/chloe/ejectives_abx/essais/vot_measures_s08.item
	...
	if fileReadable (gridfile$)
		...
		for i to ints
        	...
        	if segment$ = "p>"
                ...
                fileappend "'resultsfile$'" 'soundname$' 'oral_burst:6' 'vot_start:6' 'new_name$' 'sequence$' 'syllable_count' 'type$' 'place$' 'vowel$' 'initial$' 'speaker$' 'question$' 'echo$' 'extendVOT_duration:2' 'constriction_duration:2' 'vowelduration:2' 'vot_check$' 'vot:2' 'newline$'
