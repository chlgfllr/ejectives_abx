...
header$ = "#file onset_f offset_f onset_v offset_v item sequence syllables type place vowel position speaker question new bad_vot constriction vowelduration check_vowel good_vot 'newline$'"
	...
	if fileReadable (gridfile$)
		...
		for i to ints
        	...
        	if segment$ = "p>"
                ...
                fileappend "'resultsfile$'" 'soundname$' 'left:6' 'right:6' 'start:6' 'vowel_end:6' 'new_name$' 'sequence$' 'syllable_count' 'type$' 'place$' 'vowel$' 'initial$' 'speaker$' 'question$' 'echo$' 'extendVOT_duration:2' 'constriction_duration:2' 'vowelduration:2' 'vot_check$' 'vot:2' 'newline$'
