...
form Extract VOT measures from TextGrid
	sentence Sound_directory: /Users/chloe/OneDrive/Documents/M2/2017-2018/georgian_suite/audio_files/resampled_mono/edited/done/
	...
	text resultsfile /Users/chloe/ejectives_abx/essais/vowel_measures_s08.item
...
header$ = "#file onset_vot offset_vot item sequence syllables type place vowel position speaker question new bad_vot constriction vowelduration check_vowel good_vot 'newline$'"
	...
	if fileReadable (gridfile$)
		...
		for i to ints
        	...
        	if segment$ = "p>"
                ...
                fileappend "'resultsfile$'" 'soundname$' 'vot_start:6' 'vowel_end:6' 'new_name$' 'sequence$' 'syllable_count' 'type$' 'place$' 'vowel$' 'initial$' 'speaker$' 'question$' 'echo$' 'extendVOT_duration:2' 'constriction_duration:2' 'vowelduration:2' 'vot_check$' 'vot:2' 'newline$'
