...
egg <- readr::read_delim("../results/results_egg.csv", "\t")
...
comparison <- dplyr::inner_join(egg, egg_1000,  
                                by=c(type_2="type_2", type_1="type_1", by="by", n="n"))

#comparison$compare <- comparison$score_standard - comparison$score_smaller

#write.csv(comparison, "../results/comparison_egg.csv")
```
