...
read_distances <- function(data_folder) {
  ...
  #distances <- readr::read_delim("../results/features/avion/distance.txt", " ")
  ## ici deux problèmes : 
  ...
  #items <- readr::read_delim("../results/features/avion/abx.item", " ")
...
distances <- dplyr::bind_rows(distances_fixed_standard, distances_features, distances_egg)
