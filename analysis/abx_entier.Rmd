...
distances_fixed_large <- read_distances("fixed/by__place_question_speaker_vowel")
distances_fixed_large$experiment <- "fixed_large"
distances_fixed_small <- read_distances("smaller_mfcc/fixed/by__place_question_speaker_vowel")
distances_fixed_small$experiment <- "fixed_small"

distances <- dplyr::bind_rows(distances_fixed_large, distances_fixed_small)
