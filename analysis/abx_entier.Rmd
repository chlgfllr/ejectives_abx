...
distances_fixed <- read_distances("fixed/by__place_question_speaker_vowel")
distances_fixed$experiment <- "fixed"
distances_egg <- read_distances("egg_fixed/by__place_question_speaker_vowel")
distances_egg$experiment <- "egg"

distances <- dplyr::bind_rows(distances_fixed, distances_egg)
